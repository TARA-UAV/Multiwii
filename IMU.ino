...
/* Default WMC value: n/a*/
#define GYR_CMPFM_FACTOR 200.0f//SNR changed from 200.0f to 100.0f to decrease gyro influence
...
void getEstimatedAltitude(){
  ...
  if (SonarAlt < 0) return; //SNR Exit this routine and leave BaroPID at last value, so copter does not jump.
  BaroPID = 0;
  //D
