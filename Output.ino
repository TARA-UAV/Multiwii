...
//ESC Refresh rate to 400Hz
#define ESC_400


#if defined(PROMINI) && defined(ESC_400)
...
void writeMotors() { // [1000;2000] => [125;250]
      ...
      OCR1B = motor[1]<<3; //  pin 9
        ...
        #if defined(ESC_400)
          pwm4_LBA = 1023-(motor[2]>>1); pwm4_HBA = 0; // channel A is inverted
        #else
...
#if defined(PROMINI) && defined(ESC_400) && (NUMBER_MOTOR > 2)
...
#endif
#if defined(PROMINI) && defined(ESC_400) && (NUMBER_MOTOR > 3)
...
void initOutput() {
  for(uint8_t i=0;i<NUMBER_MOTOR;i++)
    pinMode(PWM_PIN[i],OUTPUT);
      ...
      #if defined(ESC_400)
        ICR3 |= 20000; // TOP to 20000 (for 400Hz);
      #else
      ...
      #if defined(ESC_400)
        ICR4 |= 20000; // TOP to 20000 (for 400Hz);
      #else
      ...
      #if defined(ESC_400)
        ICR1 |= 20000; // TOP to 20000 (for 400Hz);
      #else
      ...
      TCCR1A |= _BV(COM1B1); // connect pin 10 to timer 1 channel B
        ...
        #if defined(ESC_400)
          TCCR4B &= ~(1<<CS43); TCCR4B &= ~(1<<CS40); TCCR4B |= (1<<CS41)|(1<<CS42); // prescaler to 32
          TC4H = 0x2; OCR4C = 113;// top to  625 but with enhanced pwm mode we have 1024
        #else
          TCCR4B &= ~(1<<CS41); TCCR4B |= (1<<CS42)|(1<<CS40); // prescaler to 16
          TC4H = 0x3; OCR4C = 0xFF;// top to 1023 but with enhanced pwm mode we have 2047
        #endif
